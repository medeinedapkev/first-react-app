...
const programData = [
    {
        ...
        features: [
            {className: 'icon-cap', img: study, title: '1 lygis'},
            {className: 'icon-moon', img: moon, title: 'vakarais'},
        ],
        cardLabel: 'naujas',
    },
    {
        ...
        features: [
            {className: 'icon-cap', img: study, title: 'finasuojama užt -dirbantiems'},
            {className: 'icon-moon', img: moon, title: 'vakarais'},
        ],
    ...
    },
    {
        ...
        features: [
            {className: 'icon-cap', img: day, title: 'dienomis'},
        ],
        cardLabel: 'finansuojama užt',
    },
    {
